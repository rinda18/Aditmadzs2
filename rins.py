...
aditmadzs = LineClient(authToken='EwLmlQvl5L2onz67a9be.xmuvUN9DywEZbNRmpsxChG.AQNksnA/k4V9IoaqgsLYj6Kb8bRi65hVAMXtAKuY82U=')
...
#kr = LineClient()
kr = LineClient(authToken='EwMOswNrySknlz9DLjP3.zp81iCnJRS6DWRFwE7rbCW.pjYodEkBT4a54+NUparCYdfQvGrY0Pgi/9JYhFwtU4E=')
...
# Secure 1 : Anti Inviting, Secure 2 : Anti Kicking, Secure 3 : Anti Cancelling, Secure 4 : Anti Joined, Secure 5 : Anti Qr Update
                          ...
                          if wait["selfbot"] == True:
                                 ...
                                 aditmadzs.sendMessage(msg.to, "Checkread Online.")
                          ...
                          if wait["selfbot"] == True:
                                 ...
                                 aditmadzs.sendMessage(msg.to, "Checkread Offline.")
