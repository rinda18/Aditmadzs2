...
#===========Protection============#                                    
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  ...
                                  if msg.to in protectcancel:
                                      ginfo = aditmadzs.getGroup(msg.to)
                                      msgs = "All Protect aktif di Grup \n< " +str(ginfo.name) + " >"
                                  else:
                                      protectcancel.append(msg.to)
                                      ginfo = aditmadzs.getGroup(msg.to)
                                      msgs = "Berhasil Mengaktifkan Di grup \n< " +str(ginfo.name) + " >"
                                  aditmadzs.sendMessage(msg.to, "「 All Protect 」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectqr:
                                         protectqr.remove(msg.to)
                                    else:
                                    ...
                                    if msg.to in protectcancel:
                                         protectcancel.remove(msg.to)
                                         ginfo = aditmadzs.getGroup(msg.to)
                                         msgs = "All Protect tidak aktif Di Grup \n< " +str(ginfo.name) + " >"
                                    else:
                                         ginfo = aditmadzs.getGroup(msg.to)
                                         msgs = "Berhasil Mematikan Di grup \n< " +str(ginfo.name) + " >"
                                    aditmadzs.sendMessage(msg.to, "「 All Protect 」\n" + msgs)
