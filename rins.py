...
def staffs():
    key = Setmain["keyCommand"]
    key = key.title()
    staffsMessage =  "╭──「 // INSERT STAFF COMMANDS // 」──" + "\n" + \
                     "│ " + key + "Clearban\n" + \
                     "│ " + key + "Adminsc\n" + \
                     "│ " + key + "Blc\n" + \
                     "│ " + key + "Staffsc\n" + \
                            ...
                            if msg._from in admin:
                                ...
                                for i in gid:
                                    ...
                                    if h == ng:
                                        ...
                                        ki.leaveGroup(i)
                                        aditmadzs.sendMessage(to,"Sandra berhasil Keluar dari Grup\n" +h)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  ...
                                  aditmadzs.sendMessage(msg.to, "Get Diaktifkan.")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              if msg.to in cctv['point']:
                                  ...
                                  aditmadzs.sendMessage(msg.to, "Get Sider Dimatikan.")
                              else:
