                ...
                try:
                    if aditmadzs.getGroup(op.param1).preventedJoinByTicket == False:
                        if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                            ...
                            aditmadzs.sendMessage(op.param1, "Maapkeun, Security sedan Aktif")
            ...
            if admin in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ...
                        ki.kickoutFromGroup(op.param1,[op.param2])
                        ki.sendMessage(op.param1, "Maapkeun, Security sedan Aktif")
                    except:
                        try:
                          ...
                          if wait["selfbot"] == True:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     ki.sendMessage(msg.to, "Indra Masuk ke : %s" % str(group.name))
