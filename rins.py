...
def siderMembers(to, mid):
    try:
        arrData = ""
        textx = "Rinda Start Geting Siders\n\n< {} > Sider Found\n".format(str(len(mid)))
        arr = []
        no = 1
        num = 2
        for i in mid:
...
def help():
    ...
    helpMessage = "╭──「 // INSERT HELPER COMMANDS // 」──" + "\n" + \
                  ...
                  "│ " + key + "[1] Terjemah Arab*on /[off]\n" + \
                  "│ " + key + "[1] Terjemah Indo*on /[off]\n" + \
                  "│ " + key + "[1] Terjemah Eng*on /[off]\n" + \
...
def staffs():
    key = Setmain["keyCommand"]
    key = key.title()
    staffsMessage =  "╭──「 // INSERT RINDA'S STAFF COMMANDS // 」──" + "\n" + \
                     "│ " + key + "Admin:on\n" + \
                     "│ " + key + "Admin:delete\n" + \
                     "│ " + key + "Staff:on\n" + \
                     "│ " + key + "Staff:delete\n" + \
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                aditmadzs.sendMessage(msg.to," 「 Rinda BOTS List 」\n"+ma+"\n 「 Ada %s Bots 」" %(str(len(Bots))))

                        elif cmd == "rin whoadmins":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ma = ""
                                mb = ""
                                ...
                                aditmadzs.sendMessage(msg.to," 「 Rinda Dev List 」\nRinda Admins is\n"+mb+"\nRinda Staffs is\n"+mc+"\n 「 Ada %s Bots 」" %(str(len(owner)+len(admin)+len(staff))))

                        elif cmd == "rin look protect":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ma = ""
                                mb = ""
                                ...
                                aditmadzs.sendMessage(msg.to,"  「 PROTECTION STATUS 」\nAnti Inviting Aktif di Grup\n"+me+"\nAnti Kicking Aktif di Grup\n"+mb+"\nAnti Cancelling Aktif di Grup\n"+mc+"\nAnti Joined Aktif di Grup\n"+md+"\nAnti Qr Update Aktif di Grup\n"+ma+"\n  「 Ada %s yang sedang Aktif 」" %(str(len(protectqr)+len(protectkick)+len(protectjoin)+len(protectcancel)+len(protectinvite))))
                            ...
                            if msg._from in admin:
                                ...
                                for i in gid:
                                    ...
                                    if h == ng:
                                        ...
                                        ki.leaveGroup(i)
                                        aditmadzs.sendMessage(to,"Keluar dari Grup " +h)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               aditmadzs.sendMessage(msg.to, "Creating speed...")
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg.to in Setmain['ADITMADZSreadPoint']:
                                if Setmain['ADITMADZSreadMember'][msg.to] != {}:
                                    ...
                                    try:
                                        arrData = ""
                                        textx = "*Rinda Start geting Readers*\n\n1. "
                                        arr = []
                                        no = 1
                                        b = 1
                                        for i in nad:
                        ...
                        elif cmd == "getsider on":
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                                  timeNow = datetime.now(tz=tz)
                                  #aditmadzs.sendMessage(msg.to, "Get Sider Aktif\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                                  aditmadzs.sendMessage(msg.to, "Get Sider Aktif.")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              if msg.to in cctv['point']:
                                  ...
                                  aditmadzs.sendMessage(msg.to, "Get Sider Tidak Aktif.")
                              else:
                                  aditmadzs.sendMessage(msg.to, "Get Sider status : Tidak aktif")
...
## DIR ##
                        ...
                        elif 'Sandra look token' in msg.text:
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              ki.sendMessage(msg.to,"「 Token Sandra 」\n"+ki.authToken)
...
#===========Protection============#                                    
                        ...
                        elif 'Gticketpro ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Gticketpro ','')
                              if spl == 'on':
                                  if msg.to in protectqr:
                                       ...
                                       ginfo = aditmadzs.getGroup(msg.to)
                                       msgs = "Dinyalakan Di Grup \n< " +str(ginfo.name) + " >"
                                  aditmadzs.sendMessage(msg.to, "// GROUPTICKET UPDATE //\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectqr:
                        ...
                        elif 'Antikicking ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Antikicking ','')
                              if spl == 'on':
                                  if msg.to in protectkick:
                                       ...
                                       ginfo = aditmadzs.getGroup(msg.to)
                                       msgs = "Dinyalakan Di Grup \n< " +str(ginfo.name) + " >"
                                  aditmadzs.sendMessage(msg.to, "// ANTI KICKING //\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectkick:
                                       protectkick.remove(msg.to)
                                       ginfo = aditmadzs.getGroup(msg.to)
                                       msgs = "Dimatikan Di Grup \n< " +str(ginfo.name) + " >"
                                    else:
                                         msgs = "Protection Anti Kick Status is UnActived"
                                    aditmadzs.sendMessage(msg.to, "// ANTI KICKING //\n" + msgs)

                        elif 'Antijoin ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Antijoin ','')
                              if spl == 'on':
                                  if msg.to in protectjoin:
                                       ...
                                       ginfo = aditmadzs.getGroup(msg.to)
                                       msgs = "Dinyalakan Di Grup \n< " +str(ginfo.name) + " >"
                                  aditmadzs.sendMessage(msg.to, "// ANTI JOINED //\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectjoin:
                        ...
                        elif 'Anticancelling ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Anticancelling ','')
                              if spl == 'on':
                                  if msg.to in protectcancel:
                                       ...
                                       ginfo = aditmadzs.getGroup(msg.to)
                                       msgs = "Dinyalakan Di Grup \n< " +str(ginfo.name) + " >"
                                  aditmadzs.sendMessage(msg.to, "// ANTI CANCELLING //\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectcancel:
                        ...
                        elif 'Antiinviting ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Antiinviting ','')
                              if spl == 'on':
                                  if msg.to in protectinvite:
                                       ...
                                       ginfo = aditmadzs.getGroup(msg.to)
                                       msgs = "Dinyalakan Di Grup \n< " +str(ginfo.name) + " >"
                                  aditmadzs.sendMessage(msg.to, "// ANTI INVITING //\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectinvite:
                        ...
                        elif 'Antiall ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Antiall ','')
                              if spl == 'on':
                                  if msg.to in protectqr:
                                       msgs = ""
                                  else:
                                  ...
                                  if msg.to in protectcancel:
                                      ginfo = aditmadzs.getGroup(msg.to)
                                      msgs = "All Anti Status is Actived InGroup \n< " +str(ginfo.name) + " >"
                                  else:
                                      protectcancel.append(msg.to)
                                      ginfo = aditmadzs.getGroup(msg.to)
                                      msgs = "Successfully Actived All InGroup \n< " +str(ginfo.name) + " >"
                                  aditmadzs.sendMessage(msg.to, "// ALL ANTI //\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectqr:
                                         protectqr.remove(msg.to)
                                    else:
                                    ...
                                    if msg.to in protectcancel:
                                         protectcancel.remove(msg.to)
                                         ginfo = aditmadzs.getGroup(msg.to)
                                         msgs = "All Anti Status is UnActived InGroup \n< " +str(ginfo.name) + " >"
                                    else:
                                         ginfo = aditmadzs.getGroup(msg.to)
                                         msgs = "Successfully UnActived All InGroup \n< " +str(ginfo.name) + " >"
                                    aditmadzs.sendMessage(msg.to, "// ALL ANTI //\n" + msgs)
...
#===========ADMIN ADD============#
                        ...
                        elif cmd == "rin upgrade" or text.lower() == 'rinda upgrade':
                            if msg._from in admin:
                                ...
                                aditmadzs.sendMessage(msg.to, "// Rinda Upgrade Done //")
                                #aditmadzs.sendMessage(msg.to,"// Hei Upgrade Done //")

                        elif cmd == "contact admins" or text.lower() == 'contact admins':
                                ma = ""
                                for i in admin:
                                    ma = ki.getContact(i)
                                    ki.sendMessage(msg.to, None, contentMetadata={'mid': i}, contentType=13)

                        elif cmd == "contact staffs" or text.lower() == 'contact staffs':
                                ma = ""
                                for i in staff:
                                    ma = ki.getContact(i)
                                    ki.sendMessage(msg.to, None, contentMetadata={'mid': i}, contentType=13)

                        elif cmd == "contact bots" or text.lower() == 'contact bots':
                                ma = ""
                                for i in Bots:
                                    ma = ki.getContact(i)
                                    ki.sendMessage(msg.to, None, contentMetadata={'mid': i}, contentType=13)
                          ...
                          if wait["selfbot"] == True:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     aditmadzs.sendMessage(msg.to, "Rinda joining to : %s" % str(group.name))
                                     group1 = ki.findGroupByTicket(ticket_id)
                                     ki.acceptGroupInvitationByTicket(group1.id,ticket_id)
                                     ki.sendMessage(msg.to, "Sandra joining to : %s" % str(group.name))
