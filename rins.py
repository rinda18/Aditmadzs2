...
#===========Protection============#                                    
                        ...
                        elif 'Progticket ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Progticket ','')
                              if spl == 'on':
                        ...
                        elif 'Prokicking ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Prokicking ','')
                              if spl == 'on':
                        ...
                        elif 'Procancelling ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Procancelling ','')
                              if spl == 'on':
                        ...
                        elif 'Proinviting ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Proinviting ','')
                              if spl == 'on':
...
#===========ADMIN ADD============#
                        ...
                        elif cmd == "rin upgrade" or text.lower() == 'rinda refresh':
                            if msg._from in admin:
                        ...
                        elif cmd == "adminsc" or text.lower() == 'contact admins':
                                ma = ""
                                for i in admin:
                                    ma = ki.getContact(i)
                                    ki.sendMessage(msg.to, None, contentMetadata={'mid': i}, contentType=13)

                        elif cmd == "staffsc" or text.lower() == 'contact staffs':
                                ma = ""
                                for i in staff:
                                    ma = ki.getContact(i)
                                    ki.sendMessage(msg.to, None, contentMetadata={'mid': i}, contentType=13)

                        elif cmd == "botsc" or text.lower() == 'contact bots':
                                ma = ""
                                for i in Bots:
                                    ma = ki.getContact(i)
                                    ki.sendMessage(msg.to, None, contentMetadata={'mid': i}, contentType=13)
...
#===========COMMAND BLACKLIST============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              mc = "  Saat ini ada 「 %i 」 Blist" % len(ragets)
                              aditmadzs.sendMessage(msg.to,"Sukses menghapus semua Blist \n" +mc)
#===========COMMAND SET============#
