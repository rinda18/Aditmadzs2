...
aditmadzs = LineClient(authToken='EwLiF37uFpD4LPsJWNn3.Ri4/RX6YPvDWVXddSJv8mW.uC6PSWjV4U9EtgGhcyLR+s6XHPKlR/zBR7GSZBYVhyY=')
                             ...
                             "messages": [
                              {
                               ...
                               "template": {
                                 "type": "buttons",
                                 "thumbnailImageUrl": "https://obs.line-scdn.net/0hYVQVgZrTBnlsLytqX-l5LmdsChVfRx15ThEVTx97WUlJSkIsVE1IWkgmC0hGG0gv",
                                 "title": "Test",
                                 "text": "Yayaya",
                                 "actions": [
                                   {
